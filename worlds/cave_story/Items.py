...
ALL_ITEMS: Dict[str, CaveStoryItemData] = {
    ...
    "Map System": CaveStoryItemData(ItemClassification.progression, base_id+2),
    ...
    "Beast Fang": CaveStoryItemData(ItemClassification.filler, base_id+5),
    ...
    "Bomb": CaveStoryItemData(ItemClassification.progression, base_id+13),
    "Puppy": CaveStoryItemData(ItemClassification.progression, base_id+14, 5),
    "Life Pot": CaveStoryItemData(ItemClassification.progression, base_id+15),
    ...
    "Arms Barrier": CaveStoryItemData(ItemClassification.progression, base_id+19),
    "Turbocharge": CaveStoryItemData(ItemClassification.progression, base_id+20),
    "Curly's Air Tank": CaveStoryItemData(ItemClassification.progression, base_id+21),
    "Nikumaru Counter": CaveStoryItemData(ItemClassification.progression, base_id+22),
    "Mimiga Mask": CaveStoryItemData(ItemClassification.progression, base_id+24),
    "Teleporter Key": CaveStoryItemData(ItemClassification.progression, base_id+25),
    ...
    "Clay Figure Metal": CaveStoryItemData(ItemClassification.progression, base_id+31),
    ...
    "Curly's Panties": CaveStoryItemData(ItemClassification.progression, base_id+35),
    "Alien Metal": CaveStoryItemData(ItemClassification.progression, base_id+36),
    "Chaco's Lipstick": CaveStoryItemData(ItemClassification.progression, base_id+37),
    "Whimsical Star": CaveStoryItemData(ItemClassification.progression, base_id+38),
    ...
    "Machine Gun": CaveStoryItemData(ItemClassification.useful, base_id+104),
    ...
    "Blade": CaveStoryItemData(ItemClassification.useful, base_id+109),
    "Nemesis": CaveStoryItemData(ItemClassification.useful, base_id+112),
    "Spur": CaveStoryItemData(ItemClassification.useful, base_id+113),
    ...
    "+5 Life Capsule": CaveStoryItemData(ItemClassification.useful, base_id+205, 6),
