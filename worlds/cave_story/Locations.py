...
ALL_LOCATIONS: Dict[str, Optional[int]] = {
    ...
    "Grasstown - East Chest" : base_id+4,
    "Grasstown - Kazuma Chest" : base_id+5,
    "Grasstown - Kazuma Crack" : base_id+6,
    "Grasstown - West Ceiling" : base_id+7,
    "Grasstown - Kulala" : base_id+8,
    "Grasstown - West Floor" : base_id+9,
