...
ALL_LOCATIONS: Dict[str, Optional[int]] = {
    ...
    "Egg No. 06 - Egg Chest" : base_id + 2,
    "Egg Observation Room - Egg Observation Room Chest" : base_id + 3,
    "Grasstown - West Grasstown Floor" : base_id + 4,
    "Grasstown - West Grasstown Ceiling" : base_id + 5,
    "Grasstown - Grasstown East Chest" : base_id + 6,
    ...
    "Chaco's House - Chaco's Bed, where you two Had A Nap" : base_id + 12,
    "Power Room - MALCO" : base_id + 13,
    "Grasstown Hut - Grasstown Hut" : base_id + 14,
    "Execution Chamber - Execution Chamber" : base_id + 15,
    "Gum - Gum Chest" : base_id + 16,
    "Labyrinth B - Booster Chest" : base_id + 17,
    "Boulder Chamber - Boulder Chest" : base_id + 18,
    "Core - Robot's Arm" : base_id + 19,
    "Core - Drowned Curly" : base_id + 20,
    "Main Artery - Ironhead Boss" : base_id + 21,
    "Labyrinth I - Labyrinth Life Capsule" : base_id + 22,
    ...
    "Camp - Camp Chest" : base_id + 27,
    "Clinic Ruins - Puu Black Boss" : base_id + 28,
    "Last Cave (Hidden) - Red Demon Boss" : base_id + 29,
    "Sacred Grounds - B1 - Hell B1 Spot" : base_id + 30,
    "Sacred Grounds - B3 - Hell B3 Chest" : base_id + 31,
    "First Cave - First Cave Life Capsule" : base_id + 32,
    "Hermit Gunsmith - Hermit Gunsmith Chest" : base_id + 33,
    "Hermit Gunsmith - Tetsuzou" : base_id + 34,
    "Mimiga Village - Mimiga Village Chest" : base_id + 35,
    "Yamashita Farm - Yamashita Farm" : base_id + 36,
    "Reservoir - Reservoir" : base_id + 37,
    "Assembly Hall - Assembly Hall Fireplace" : base_id + 38,
    "Graveyard - Arthur's Grave" : base_id + 39,
    "Graveyard - Mr. Little (Graveyard)" : base_id + 40,
    "Storage - Storage? Chest" : base_id + 41,
    "Storage - Ma Pignon Boss" : base_id + 42,
    "Arthur's House - Professor Booster" : base_id + 43,
    "Plantation - Kanpachi's Bucket" : base_id + 44,
    "Plantation - Jammed it into Curly's mouth" : base_id + 45,
    "Plantation - Broken Sprinker" : base_id + 46,
    "Plantation - Plantation Platforming Spot" : base_id + 47,
    "Plantation - Plantation Puppy" : base_id + 48,
    "Storehouse - Itoh" : base_id + 49,
    "Rest Area - Megane" : base_id + 50,
    "Jail No. 1 - Jail No. 1" : base_id + 51,
    "Hideout - Chivalry Sakamoto's Wife" : base_id + 52,
    "Egg Corridor? - Dragon Chest" : base_id + 53,
    "Egg Observation Room? - Sisters Boss" : base_id + 54,
    "Little House - Little House" : base_id + 55,
    "Clock Room - Clock Room" : base_id + 56,
    "Sand Zone - Polish Spot" : base_id + 57,
    "Sand Zone - Pawprint Spot" : base_id + 58,
    "Sand Zone - Puppy (Chest)" : base_id + 59,
    "Sand Zone - Puppy (Run)" : base_id + 60,
    "Sand Zone - Puppy (Sleep)" : base_id + 61,
    "Sand Zone Residence - Curly Boss" : base_id + 62,
    "Small Room - Puppy (Curly)" : base_id + 63,
    "Small Room - Curly's Closet" : base_id + 64,
    "Jenka's House - Jenka" : base_id + 65,
    "Deserted House - Puppy (Dark)" : base_id + 66,
